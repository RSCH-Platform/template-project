...
export default function Notification() {
    ...
    const lowStockNotifications = props.lowStockNotifications || [];
    const receivableNotifications = props.receivableNotifications || [];
    const payableNotifications = props.payableNotifications || [];
    ...
    // Sync when notifications change from props
    useEffect(() => {
        setData(mergeData());
    }, [
        props.lowStockNotifications, 
        props.receivableNotifications, 
        props.payableNotifications
    ]);
