...
export default function Login({ status, canResetPassword, canRegister, botGuard, isLocal, loginType = 'email' }) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        [loginType]: isLocal ? (loginType === 'email' ? "juniyasyos@gmail.com" : "0000.00000") : "",
                        ...
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type={loginType === 'nip' ? 'text' : 'email'}
                                        value={data[loginType]}
                                        onChange={(e) =>
                                            setData(loginType, e.target.value)
                                        }
                                        placeholder={loginType === 'nip' ? '0000.00000' : 'nama@email.com'}
                ...
                <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-500 to-primary-700 items-center justify-center p-12">
                    <div className="max-w-md text-center text-white">
                        ...
                        <p className="text-lg opacity-90">
                            Template untuk pengembangan aplikasi yang memudahkan proses pembuatan sistem dengan fitur yang terstruktur.
                        </p>
